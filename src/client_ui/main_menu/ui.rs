...
use crate::client_ui::main_menu::{OnAttemptConnect, OnAttemptHost};
...
pub trait MainMenuExt {
    fn connect_menu(&mut self, server_ip: &mut String, connect_writer: EventWriter<OnAttemptConnect>);

    fn host_menu(&mut self, server_port: &mut String, host_writer: EventWriter<OnAttemptHost>);
}

impl MainMenuExt for Ui {
    fn connect_menu(&mut self, server_ip: &mut String, mut connect_writer: EventWriter<OnAttemptConnect>) {
            ...
            ui.menu_button(RichText::new("Join Server").heading(), |ui| {
                ...
                ui.horizontal_top(|ui| {
                    ...
                    if ui.add_enabled(
                        ...
                        connect_writer.send(OnAttemptConnect);
                    }
                });
            ...
            ui.menu_button(RichText::new("Host Server").heading(), |ui| {
                ...
                ui.horizontal_top(|ui| {
                    ...
                    if ui.add_enabled(
                        ...
                        host_writer.send(OnAttemptHost);
                    }
                });
                if ui.button("Back").clicked() {
                    ui.close_menu();
